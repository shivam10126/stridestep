...
import { ShoppingBag, Sliders, Smile } from 'lucide-react';
  ...
  return (
    <div className="flex font-roboto-slab w-full mt-5 h-min flex-col items-center justify-center p-8 text-center max-w-3xl mx-auto">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <Button variant="default" className="bg-[#eb432f] hover:bg-[#6e36aa] text-white" onClick={resetAll}>
          <ShoppingBag className="w-4 h-4 mr-2" />
          Browse All Products
        </Button>
        <Button variant="secondary" className="bg-[#6e36aa] hover:bg-[#eb432f] text-white" onClick={resetAll}>
