...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full font-roboto-slab h-[92vh] overflow-hidden">
      {slides.map((slide, index) => (
        ...
        >
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-white">
            <h1 className="text-6xl md:text-7xl w-[70%] mx-auto text-center font-bold mb-4" style={{ color: '#eb432f' }}>
              {slide.heading}
            </h1>
